<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="行业协同创新中心数或产学研基地数" prop="industryInnovationCenterCount" width="120" />
        <el-table-column sortable align="left" label="区域协同创新中心数或产学研基地数" prop="regionalInnovationCenterCount" width="120" />
        <el-table-column sortable align="left" label="学校名称" prop="universityName" width="120" />
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateSocialServiceDatabaseFunc(scope.row)">变更</el-button>
      ...
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="行业协同创新中心数或产学研基地数:"  prop="industryInnovationCenterCount" >
              <el-input v-model.number="formData.industryInnovationCenterCount" :clearable="true" placeholder="请输入行业协同创新中心数或产学研基地数" />
            </el-form-item>
            <el-form-item label="区域协同创新中心数或产学研基地数:"  prop="regionalInnovationCenterCount" >
              <el-input v-model.number="formData.regionalInnovationCenterCount" :clearable="true" placeholder="请输入区域协同创新中心数或产学研基地数" />
            </el-form-item>
            <el-form-item label="学校名称:"  prop="universityName" >
              <el-input v-model="formData.universityName" :clearable="true"  placeholder="请输入学校名称" />
            </el-form-item>
          </el-form>
      </el-scrollbar>
      <template #footer>
