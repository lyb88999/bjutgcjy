...
func Routers() *gin.Engine {
	...
	{
		EngineeringEducationDatabaseRouter := router.RouterGroupApp.EngineeringEducationDatabase

		EngineeringEducationDatabaseRouter.InitSocialServiceDatabaseRouter(PrivateGroup)

		EngineeringEducationDatabaseRouter.InitConditionalGuaranteeDatabaseRouter(PrivateGroup)

		EngineeringEducationDatabaseRouter.InitPolicyDatabaseRouter(PrivateGroup)
		EngineeringEducationDatabaseRouter.InitProfessionalConstructionDatabaseRouter(PrivateGroup)
		EngineeringEducationDatabaseRouter.InitSubjectConstructionDatabaseRouter(PrivateGroup)
		EngineeringEducationDatabaseRouter.InitTalentTrainingDatabaseRouter(PrivateGroup)
		EngineeringEducationDatabaseRouter.InitInternationalExchangeDatabaseRouter(PrivateGroup)
		EngineeringEducationDatabaseRouter.InitBasicInfomationDatabaseRouter(PrivateGroup)
	...
	}
	{
		...
		utilRouter.InitInviteCodeRouter(PrivateGroup)
	}
