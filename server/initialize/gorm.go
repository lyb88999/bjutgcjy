...
func RegisterTables() {
	...
	err := db.AutoMigrate(
		...
		ExpertDatabase.ExpertProfile{}, ExpertDatabase.ExpertAchievement{}, ExpertDatabase.ExpertAdoptionRecord{}, ExpertDatabase.ExpertTag{}, ExpertDatabase.ExpertTagRelation{}, ExpertDatabase.ExpertAcademicPosition{},
	)
	if err != nil {
