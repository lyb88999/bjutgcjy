...
func RegisterTables() {
	...
	err := db.AutoMigrate(
		...
		ExpertDatabase.ExpertProfile{}, ExpertDatabase.ExpertAchievement{}, ExpertDatabase.ExpertAdoptionRecord{}, ExpertDatabase.ExpertTag{}, ExpertDatabase.ExpertTagRelation{}, ExpertDatabase.ExpertAcademicPosition{}, ExpertDatabase.ExpertApprovalLog{},
	)
	if err != nil {
