      ...
      <el-scrollbar height="200px">
        <el-descriptions :column="1" border>
          ...
          <el-descriptions-item label="行业协同创新中心数或产学研基地数">
            <span v-if="formData.industryInnovationCenterCount < 0">暂无</span>
            <span v-else>{{ formData.industryInnovationCenterCount }}</span>
          </el-descriptions-item>
          <el-descriptions-item label="区域协同创新中心数或产学研基地数">
            <span v-if="formData.regionalInnovationCenterCount < 0">暂无</span>
            <span v-else>{{ formData.regionalInnovationCenterCount }}</span>
          </el-descriptions-item>
...
const formData = ref({
  universityName: '',
  industryInnovationCenterCount: -1,
  regionalInnovationCenterCount: -1,
