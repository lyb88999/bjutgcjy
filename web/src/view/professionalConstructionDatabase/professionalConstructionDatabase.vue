<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table ref="multipleTable" style="width: 100%" tooltip-effect="dark" height="500":data="tableData" row-key="ID"
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" :title="type === 'create' ? '添加' : '修改'"
      ...
      <el-scrollbar height="500px">
        <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="40%">
          ...
          <el-form-item label="专业满意度:" prop="majorSatisfaction">
            <el-select v-model="formData.majorSatisfaction" placeholder="请选择专业满意度" style="width:200px" :clearable="true">
          ...
          <el-form-item label="计划招生数:" prop="plannedEnrollment">
            <el-input v-model.number="formData.plannedEnrollment" :clearable="true" placeholder="请输入计划招生数" style="width: 200px;"/>
          </el-form-item>
        </el-form>
      </el-scrollbar>
      <template #footer>
